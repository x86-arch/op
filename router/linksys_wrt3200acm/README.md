...
You can download the OpwnWrt for Linksys WRT3200ACM firmware from [Releases](https://github.com/ophub/op/releases). Such as `OpenWrt_Linksys_WRT3200ACM_${date}`.
...
- Select ***`Build OpenWrt for Linksys WRT3200ACM`*** on the [Action](https://github.com/ophub/op/actions) page.
