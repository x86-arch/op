...
You can download the OpwnWrt for Linksys WRT1900ACS firmware from [Releases](https://github.com/ophub/op/releases). Such as `OpenWrt_Linksys_WRT1900ACS_${date}`.
