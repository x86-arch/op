...
#========================================================================================================================
#
# example: ~/op/router/s905x3/build_kernel/
# ├── flippy
...
# 03. cd ~/op/router/s905x3/build_kernel/
# 04. Put Flippy's ${flippy_file} file into ${flippy_folder}
# 05. Run: sudo ./make_use_armbian.sh
# 06. The generated files path: ~/op/router/s905x3/armbian/kernel/${build_save_folder}
...
# copy armbian_boot.tar.xz & armbian_root.tar.xz to ~/op/router/s905x3/armbian/kernel/${build_save_folder}
copy_armbian_kernel() {

   cd ../../
   cp -rf ${build_save_folder} ../armbian/kernel/
   sync

   echo_color "green" "(6/7) End copy_armbian_kernel"  "Copy /${build_save_folder} to ../armbian/kernel/ ..."
